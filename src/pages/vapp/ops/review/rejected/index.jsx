...
import { RejectedRequests } from "@/components/vapp/ops/review/RejectedRequests";
...
/**
 * Rejected Requests Page (Ops Console)
  ...
  return (
    <Container className="py-6">
      <VappPageHeader
        ...
        pageDescription="Requests that have been rejected"
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          <PermissionGuard permission={PERMISSIONS.VAPP.REVIEW.READ}>
            <RejectedRequests eventId={eventId} />
          </PermissionGuard>
        </div>
      </div>
    </Container>
